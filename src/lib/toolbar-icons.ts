// 图标复制自 @milkdown/crepe 斜杠菜单内置 SVG（fill 风格，
// 与 index.css 的 .toolbar-item svg { color/fill } 规则兼容），
// 用于浮动工具栏扩展按钮，保持与斜杠菜单一致的视觉语言。
// 已移除原本的 <clipPath>（裁切 24x24 ≡ 全 viewBox，纯 no-op），
// 避免与 Crepe 自带 SVG 中同名 ID 碰撞导致渲染错乱。
